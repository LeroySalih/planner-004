  ...
  return (
    <div className="space-y-6">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {sessions.map((session, i) => (
              ...
              >
                <td className="px-4 py-2">{formatDateTime(session.startedAt)}</td>
                <td className="px-4 py-2">{session.lessonTitle}</td>
      ...
      {sessions.map((session) => (
        <div key={session.sessionId} className="rounded-lg border">
          <div className="flex flex-wrap items-center gap-3 border-b px-4 py-3">
            ...
            <span className="text-sm font-medium">{session.lessonTitle}</span>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="px-4 py-2 text-left font-medium">Chosen Answer</th>
