...
import { Users, ShieldAlert, CalendarDays, GraduationCap, BookOpen, ClipboardList, Cpu, CalendarRange } from "lucide-react"
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href="/admin/sow">
        <Card className="hover:bg-muted/50 transition-colors cursor-pointer">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Scheme of Work</CardTitle>
            <CalendarRange className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">Plan Units</div>
            <p className="text-xs text-muted-foreground">Units per subject, year group and half term</p>
          </CardContent>
        </Card>
      </Link>
      <Link href="/admin/unit-curricula">
        <Card className="hover:bg-muted/50 transition-colors cursor-pointer">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Unit Curricula</CardTitle>
            <ClipboardList className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">Remediate</div>
            <p className="text-xs text-muted-foreground">Fix units spanning multiple curricula</p>
          </CardContent>
        </Card>
      </Link>
      ...
      <Link href="/admin/school-years">
        <Card className="hover:bg-muted/50 transition-colors cursor-pointer">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Add, edit and deactivate school years</p>
          </CardContent>
        </Card>
      </Link>
      ...
      <Link href="/admin/ai-models">
        <Card className="hover:bg-muted/50 transition-colors cursor-pointer">
          ...
          <CardContent>
            <div className="text-2xl font-bold">Configure</div>
            <p className="text-xs text-muted-foreground">Choose which model marks which activity</p>
          </CardContent>
        </Card>
      </Link>
