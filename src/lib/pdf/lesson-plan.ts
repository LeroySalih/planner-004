...
/**
 * Render one lesson's plan as a PDF.
 *
 * Lifted out of the single-lesson route so the day-at-a-time download builds
 * the same document instead of keeping a second copy of it in step.
 *
