-- Fix reports_get_prepared_report_dataset to return empty arrays instead of null
-- This fixes Zod validation errors when memberships/assignments/feedback/units are empty
