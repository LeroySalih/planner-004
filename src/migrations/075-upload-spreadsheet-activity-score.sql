-- Score "upload-spreadsheet" activities the same way as short-text-question:
-- read ai_model_score (AI marking), falling back to score/auto_score.
...
begin
  ...
  elsif normalized_type = 'short-text-question' or normalized_type = 'upload-spreadsheet' then
