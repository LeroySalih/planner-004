-- Parameterized version of assignments_bootstrap that filters by group_ids
-- Used by /assignments page to load data for selected classes only
...
begin
  result := jsonb_build_object(
    ...
    'units', coalesce((
      ...
      from (
        select distinct u.unit_id, u.title, u.subject, u.description, u.year, coalesce(u.active, true) as active
        from units u
