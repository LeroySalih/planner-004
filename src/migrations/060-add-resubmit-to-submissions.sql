-- Add resubmit columns to submissions table
ALTER TABLE public.submissions
  ADD COLUMN IF NOT EXISTS resubmit_requested boolean DEFAULT false NOT NULL,
  ADD COLUMN IF NOT EXISTS resubmit_note text;

-- Update reports RPC to include resubmit fields in submission JSON output
