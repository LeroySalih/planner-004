...
-- Please report an issue for any failure with the reproduction steps. 
 ...
 ALTER TABLE public.pupil_sign_in_history
    ALTER COLUMN pupil_sign_in_history_id TYPE text COLLATE pg_catalog."default";

ALTER TABLE IF EXISTS public.pupil_sign_in_history
    ALTER COLUMN pupil_sign_in_history_id SET STORAGE EXTENDED;
ALTER TABLE IF EXISTS public.pupil_sign_in_history DROP CONSTRAINT IF EXISTS pupil_sign_in_history_pkey;
ALTER TABLE IF EXISTS public.pupil_sign_in_history DROP CONSTRAINT IF EXISTS pupil_sign_in_history_pupil_id_fkey;

ALTER TABLE IF EXISTS public.pupil_sign_in_history
    ADD CONSTRAINT pupil_sign_in_history_pupil_id_fkey FOREIGN KEY (pupil_id)
    REFERENCES public.profiles (user_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
DROP INDEX IF EXISTS public.idx_pupil_sign_in_history_pupil;
CREATE OR REPLACE FUNCTION public.lesson_detail_bootstrap(IN p_lesson_id text)
    RETURNS jsonb
    LANGUAGE 'plpgsql'
