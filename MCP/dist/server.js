...
function registerResources() {
    server.registerResource('planner-playbook', 'planner://playbook', {
    ...
    server.registerResource('planner-todos', 'planner://todos', {
        title: 'Planner TODOs',
    ...
    server.registerResource('workspace-file', workspaceFileTemplate, {
...
function registerTools() {
    ...
    server.registerTool('read_workspace_file', {
        ...
        description: 'Read a UTF-8 file relative to the repo root. Intended for smaller files and code snippets.',
        inputSchema: {
            relativePath: z
                .string()
                .min(1)
            ...
            byteLimit: z
                ...
                .describe(`Optional byte ceiling for the response (defaults to ${DEFAULT_FILE_BYTE_LIMIT} bytes).`)
                .optional()
        },
        outputSchema: {
